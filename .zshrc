# Enable Powerlevel10k instant prompt. Should stay close to the top of ~/.zshrc. (CURRENTLY DISABLED)
...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting web-search npm)
